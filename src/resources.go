...
fn newResources() Resources:
    return Resources{
        registry:  newComponentRegistry(),
        resources: make([]any, MASK_TOTAL_BITS),
...
fn (r *Resources) Add(id ResID, res any):
...
fn (r *Resources) Remove(id ResID):
    if r.resources[id] == nil:
...
fn (r *Resources) get(id ResID) interface{}:
...
fn (r *Resources) Has(id ResID): Bool:
    return r.resources[id] != nil

# reset removes all resources.
fn (r *Resources) reset():
