...
fn BenchmarkEntityAlive_1000(b *testing.B):
    b.StopTimer()
...
fn BenchmarkGetResource(b *testing.B):
    b.StopTimer()
...
fn BenchmarkGetResourceShortcut(b *testing.B):
    b.StopTimer()
...
fn BenchmarkNewEntities_10_000_New(b *testing.B):
    for i = 0; i < b.N; i++:
        world = NewWorld(NewConfig().WithCapacityIncrement(1024))
...
fn BenchmarkNewEntitiesBatch_10_000_New(b *testing.B):
    for i = 0; i < b.N; i++:
        world = NewWorld(NewConfig().WithCapacityIncrement(1024))
...
fn BenchmarkNewEntities_10_000_Reset(b *testing.B):
    b.StopTimer()
    world = NewWorld(NewConfig().WithCapacityIncrement(1024))
...
fn BenchmarkNewEntitiesBatch_10_000_Reset(b *testing.B):
    b.StopTimer()
    world = NewWorld(NewConfig().WithCapacityIncrement(1024))
...
fn BenchmarkRemoveEntities_10_000(b *testing.B):
    for i = 0; i < b.N; i++:
        b.StopTimer()
...
fn BenchmarkWorldNewQuery(b *testing.B):
    b.StopTimer()
    world = NewWorld(NewConfig().WithCapacityIncrement(10000))
    posID = ComponentID[Position](&world)
    velID = ComponentID[Velocity](&world)
...
fn BenchmarkWorldNewQueryNext(b *testing.B):
    b.StopTimer()
    world = NewWorld(NewConfig().WithCapacityIncrement(10000))
...
fn BenchmarkWorldNewQueryCached(b *testing.B):
    b.StopTimer()
    world = NewWorld(NewConfig().WithCapacityIncrement(10000))
    posID = ComponentID[Position](&world)
    velID = ComponentID[Velocity](&world)
...
fn BenchmarkWorldNewQueryNextCached(b *testing.B):
    b.StopTimer()
    world = NewWorld(NewConfig().WithCapacityIncrement(10000))
...
fn BenchmarkRemoveEntitiesBatch_10_000(b *testing.B):
    for i = 0; i < b.N; i++:
        b.StopTimer()
        world = NewWorld(NewConfig().WithCapacityIncrement(10000))
...
fn BenchmarkWorldStats_1Arch(b *testing.B):
    b.StopTimer()
...
fn BenchmarkWorldStats_10Arch(b *testing.B):
    b.StopTimer()
