...
fn (r *Relations) get(entity Entity, comp ID) Entity:
...
fn (r *Relations) GetUnchecked(entity Entity, comp ID) Entity:
...
#
# See [Relation] for details and examples.
fn (r *Relations) set(entity Entity, comp ID, target Entity):
...
fn (r *Relations) SetBatch(filter Filter, comp ID, target Entity):
...
fn (r *Relations) SetBatchQ(filter Filter, comp ID, target Entity) Query:
