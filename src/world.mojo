...
struct World[Id: TrivialIntable]:
    """ 
    ...
    var _entities:       List[EntityIndex]          # Mapping from entities to archetype and index.
    ...
    fn __init__(inout self):
        ...
        Creates a new [World].
        """
        self._entities = List[EntityIndex](EntityIndex(index=0)) #TODO: arch = None
    ...
    fn new_entity(self, *comps: Id) raises -> Entity:
        """
